...
import { TooltipIconButton } from "@/features/tasks/components/assistant-ui/tooltip-icon-button";
...
const defaultComponents = memoizeMarkdownComponents({
  ...
  h5: ({ className, ...props }) => <h5 className={cn("aui-md-h5 mt-2 mb-1 font-medium text-sm first:mt-0 last:mb-0", className)} {...props} />,
  h6: ({ className, ...props }) => <h6 className={cn("aui-md-h6 mt-2 mb-1 font-medium text-sm first:mt-0 last:mb-0", className)} {...props} />,
  p: ({ className, ...props }) => <p className={cn("aui-md-p my-2.5 leading-normal first:mt-0 last:mb-0", className)} {...props} />,
  a: ({ className, ...props }) => (
