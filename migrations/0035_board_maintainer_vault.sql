ALTER TABLE ama_agent_sessions ADD COLUMN secret_ref TEXT;
...
INSERT INTO board_maintainers_next (
  ...
  prompt, interval_seconds, heartbeat_enabled, status, last_run_at, last_ama_session_id,
  last_error_message, api_key_id, created_at, updated_at
)
SELECT
  id, owner_id, board_id, agent_id, ama_schedule_id, ama_http_trigger_id, ama_memory_store_id,
  prompt, interval_seconds, heartbeat_enabled, status, last_run_at, last_ama_session_id,
