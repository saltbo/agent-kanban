...
// section: 3.1 Board page renders six kanban columns

import { expect, test } from "@playwright/test";
import { signUpAndGetBoard } from "../helpers/auth";

test.describe("Board Page", () => {
  test("Board page renders six kanban columns", async ({ page }) => {
    ...
    // expect: Six columns are visible: Todo, In Progress, In Review, Error, Done, Cancelled
    ...
    await expect(countBadges).toHaveCount(6);
  });
});
